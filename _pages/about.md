...
- **Topics:** LLM Reasoning, Reinforcement Learning, Vision-Language Model Hallucination, LLM Truthfulness, Interpretability

Publications
======
(* denotes equal contribution; authors are listed in the order recorded for each work)
